...
def fix_notebook():
    file_name = "tse_snapshot_day.ipynb"
    ...
    # Check if we already fixed it (idempotency)
    for cell in nb['cells']:
        if any("Cell 2: Path setup & imports" in line for line in cell.get('source', [])):
            print("Notebook already fixed.")
            return
    ...
    cell_imports = {
        ...
        "source": [
            ...
            "    except:\n",
            "        pass\n",
            "print('Imports and metadata setup done.')\n"
        ]
    }
    ...
    cell_tickers = {
        ...
        "source": [
            ...
            "    else:\n",
            "        print(\"Error: master_df is empty.\")\n",
            "        TICKERS = []\n",
            "except Exception as e:\n",
            "    print(f\"Error building tickers: {e}\")\n",
            "    traceback.print_exc()\n",
            "    TICKERS = []\n"
        ]
    }
